...
public class Order implements Command{
	...
	@Override
	public int hashCode() {
		return Objects.hash(clientName, creationDate, mainEvent, name, status);
	}
	...
	public String toString() {
		return "Order [name=" + name + ", mainEvent=" + mainEvent + ", clientName=" + clientName + ", creationDate="
				+ creationDate + ", status=" + status + ", getName()=" + getName() + ", getMainEvent()="
				+ getMainEvent() + ", getClientName()=" + getClientName() + ", getCreationDate()=" + getCreationDate()
